...
int main()
{
    ...
    ftime=t->tm_yday;//For Calculating room vacancy//

    //Checking for hotel getting full//
    frequency();
   ...
   //new Code//
   printf("\n\n\n");
    printf("enter the duration of stay:");
    scanf("%d",&duration);
    printf("enter the no. of visitors:");
    scanf("%d",&v);
    one.cost=(price*duration*v);
    one.cyday=ftime+duration;
